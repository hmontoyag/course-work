...
public class MathToolsTest {
	...
	@Test(timeout = 100)
	public void testNthRootValueLessThanZero() {
		double actual = MathTools.nthRoot(-3, 2);
		double expected = 0;
		String message = "nthRoot(): check when value is negative";
		assertEquals(message, expected, actual, DELTA);
	}
	
	@Test(timeout = 100)
	public void testNthRootValueEqualZero() {
		double actual = MathTools.nthRoot(0, 2);
		double expected = 0;
		String message = "nthRoot(): check when value is zero";
		assertEquals(message, expected, actual, DELTA);
	}
	
	@Test(timeout = 100)
	public void testNthRootRootEqualZero() {
		double actual = MathTools.nthRoot(2, 0);
		double expected = 0;
		String message = "nthRoot(): check when root is zero";
		assertEquals(message, expected, actual, DELTA);
	}
	
	@Test(timeout = 100)
	public void testNthRootRootLessThanZero() {
		double actual = MathTools.nthRoot(42, -3);
		double expected = 0.28768479;
		String message = "nthRoot(): check when value is positive and root is negative";
		assertEquals(message, expected, actual, DELTA);
	}
	
	@Test(timeout = 100)
	public void testNthRootRootGreaterThanZero() {
		double actual = MathTools.nthRoot(42, 3);
		double expected = 3.47602664;
		String message = "nthRoot(): check when value is positive and root is positive";
		assertEquals(message, expected, actual, DELTA);
	}
	
	@Test(timeout = 100)
	public void testNthRootIntegerResult() {
		double actual = MathTools.nthRoot(8, 3);
		double expected = 2;
		String message = "nthRoot(): check when value and root have integer result";
		assertEquals(message, expected, actual, DELTA);
	}
